...
public class MonitorizacionMemoriaDto {
    ...
    public MonitorizacionMemoriaDto() {
    }

    public MonitorizacionMemoriaDto(MonitorizacionMemoria entity) {
        updateFrom(entity);
    ...
    public MonitorizacionMemoria mapEntity() {
        return new MonitorizacionMemoria(this);
    }

    private void updateFrom(MonitorizacionMemoria entity) {
        this.total = entity.getTotal();
        this.usado = entity.getUsado();
        this.libre = entity.getLibre();
        this.porcentaje = entity.getPorcentaje();
